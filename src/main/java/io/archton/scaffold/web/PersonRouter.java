...
public class PersonRouter {
    ...
    public Response createPersonFromForm(@FormParam("firstName") String firstName,
        ...
        try {
            ...
            String html = Templates.person(null, enteredData, errorMessage, titleList, genderList).getFragment("create").data("person", enteredData).data("errorMessage", errorMessage).data("titles", titleList).data("genders", genderList).render();
    ...
    public Response updatePersonFromForm(@PathParam("id") Long id,
        ...
        try {
            ...
            String errorMessage = WebErrorHandler.getUserFriendlyMessage(e);
            String html = Templates.person(null, person, errorMessage, titleList, genderList).getFragment("edit").data("person", person).data("errorMessage", errorMessage).data("titles", titleList).data("genders", genderList).render();
