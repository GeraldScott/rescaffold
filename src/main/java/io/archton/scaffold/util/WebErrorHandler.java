...
public class WebErrorHandler {
    ...
    /**
     * Creates a NOT_FOUND response without HTML content.
     * Useful for cases where the entity doesn't exist and no HTML rendering is needed.
     */
    ...
    /**
     * Creates a NOT_FOUND response for a specific entity type.
     * Includes user-friendly error message in the response body.
     */
    public static Response createNotFoundResponse(String entityType, Object id) {
        EntityNotFoundException notFound = new EntityNotFoundException(entityType, id);
        String errorMessage = getUserFriendlyMessage(notFound);
