...
public class TitlePage {
    ...
    // Navigation methods
    public TitlePage clickCreateButton() {
    ...
    public TitlePage clickViewButton(Long titleId) {
        $("#view-btn-" + titleId).click();
        return this;
    }

    public TitlePage clickEditButton(Long titleId) {
        $("#edit-btn-" + titleId).click();
        return this;
    }

    public TitlePage clickDeleteButton(Long titleId) {
        $("#delete-btn-" + titleId).click();
        return this;
    }

    public TitlePage clickBackButton() {
        backButton.click();
        return this;
    }

    public TitlePage clickSubmitCreateButton() {
        submitCreateButton.click();
        return this;
    }

    public TitlePage clickCancelCreateButton() {
        cancelCreateButton.click();
        return this;
    }

    public TitlePage clickSubmitEditButton() {
        submitEditButton.click();
        return this;
    }

    public TitlePage clickCancelEditButton() {
        cancelEditButton.click();
        return this;
    }

    public TitlePage clickConfirmDeleteButton() {
        confirmDeleteButton.click();
        return this;
    }

    public TitlePage clickCancelDeleteButton() {
        cancelDeleteButton.click();
        return this;
    }

    // Form input methods
    public TitlePage enterCode(String code) {
        codeInput.setValue(code);
        return this;
    }

    public TitlePage enterDescription(String description) {
        descriptionInput.setValue(description);
        return this;
    }

    public TitlePage setActive(boolean active) {
    ...
    public boolean hasTitleWithCode(String code) {
